                                    ...
                                    <div class="ibox-content">
                                        <form method="post" class="form-horizontal" id="modeladd" onsubmit="" enctype="" action="" target="">
                                              <div class="col-sm-12">
                                                            ...
                                                            <input type="text" name="zuming" class="form-control col-sm-10" value="王毅">        
                                 			  </div>
                                 			  <div class="col-sm-12">
                                                            <label class="control-label">职称：</label>
                                                            <select class="form-control col-sm-10" name="zhicheng" id="zc">
