                             ...
                             <div class="ibox float-e-margins">
                                   <!--  <div class="ibox-title">
                                    ...
                                    <div class="ibox-content">
                                        <form method="post" class="form-horizontal" id="elementadd" onsubmit="" enctype="" action="${path}/orgController/addElement" target="J_iframe"><!-- target="J_iframe" -->
                                              <div class="col-sm-12">
                                             			<input type="hidden" name="pid" id="pid" value="${orgParent.id}" >	
                                                            <label class="control-label">组名：</label>
                                                            
                                                               <input type="text" name="orgname" id="orgname" class="form-control col-sm-10" >
