                             ...
                             <div class="ibox float-e-margins">
                                   <!--  <div class="ibox-title">
                                    ...
                                    <div class="ibox-content">
                                        <form method="post" class="form-horizontal" id="modeladd" onsubmit="" enctype="" action="${path}/orgController/editElementGw" target="J_iframe">
                                              <div class="col-sm-12">
                                             			<input type="hidden" name="id" id="id" value="${YYOrginfo.id}" >
                                             			<input type="hidden" name="pid" id="pid" value="${YYOrginfo.pid}" >
                                                            <label class="control-label">岗位名：</label>
                                                            
                                                          	   <input type="text" name="orgname" id="orgname" class="form-control col-sm-10" value="${YYOrginfo.orgname}">
                                 			  </div>
