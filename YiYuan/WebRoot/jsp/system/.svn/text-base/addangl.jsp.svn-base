           				 ...
           				 <div class="col-sm-12">
               				 <div class="ibox float-e-margins">
				                    ...
				                    <div class="ibox-content">
				                        <form method="post" class="form-horizontal" id="addangl_form">
				                        <div>
				                        <div class="col-sm-9">
				                         ...
				                         <div class="col-sm-9">
				                                ...
				                                <%-- <div class="col-sm-8">
				                                    <select  type="text" class="form-control" name="buttonpage" id="buttonpage">
				                                ...
				                                <div class="col-sm-8">
				                                    <input type="text" class="form-control" id="buttonpage" name="buttonpage"> 
				                                </div>
				                            </div>
				                            <div class="col-sm-9">
				                                <label class="col-sm-4 control-label">按钮id</label>
				                                <div class="col-sm-8">
				                                    <input type="text" class="form-control" id="buttonpageid" name="buttonpageid"> 
				                                </div>
				                        </div>
				                        <div class="col-sm-9">
				                                <label class="col-sm-4 control-label">按钮name</label>
				                                <div class="col-sm-8">
				                                    <input type="text" class="form-control" id="buttonpagename" name="buttonpagename"> 
				                                </div>
				                        </div>
