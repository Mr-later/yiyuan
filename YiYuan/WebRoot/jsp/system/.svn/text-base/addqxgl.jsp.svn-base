...
<body class="gray-bg">
               				 ...
               				 <div class="ibox float-e-margins">
				                    ...
				                    <div class="ibox-content">
									    <div class="modal-body">
						                    <div class="row">
						                    	<form role="form" id="addqxgl_form">
						                        <div class="col-sm-4 b-r">
						                                ...
						                                <div class="form-group">
						                                    <label>说明：</label>
						                                    <input type="text" class="form-control" id="description" name="miaoshu">
						                                </div>
						                                <div>
  ...
  <!-- jsTree plugin javascript -->
    ...
    $(function(){
    	$('#jstree1').jstree({ 'core' : {
    	    'data' : {
    	        url : '${path}/functionController/getTree',
    		}
    	},
    	'plugins': ['checkbox'],
        'types': {
    	...
    	$('#jstree2').jstree({ 'core' : {
    	    'data' : {
    	        url : '${path}/buttoninfoController/getTree',
    		}
    	},
    	'plugins': ['checkbox'],
        'types': {
    ...
    $("#addqxgl_form").on("submit",function(){
    	...
    	var buttonodes = $.jstree.reference($("#jstree2")).get_selected(); 
    	 $.each(buttonodes, function(i, n) {  
    		 buttonids += n+",";
     	});  
    	var funBun=functionids+buttonids;
    	if(funBun==null || ""==funBun || funBun==undefined ||  funBun.trim()==""){
    		layer.msg("请选择至少一个角色权限");
    		return false;
    	} 
    	var rolename = $("#rolename").val();
    	var miaoshu = $("#description").val();
    	$.ajax({
    		 
			url : '${path}/roleinfoController/addElement',
			method: 'post',
			async: false,
			data:{functionids : functionids,buttonids : buttonids, rolename : rolename , miaoshu : miaoshu},
			dataType : 'json',
