...
<body class="gray-bg">
           				 ...
           				 <div class="col-sm-12">
               				 <div class="ibox float-e-margins">
				                    ...
				                    <div class="ibox-content">
				                        <form method="post" class="form-horizontal" id="addsjzd_form" >
				                        <div>
				                         <div class="col-sm-9">
				                                <label class="col-sm-4 control-label">key</label>
				                                <div class="col-sm-8">
				                                  <input type="text" class="form-control" id="dictkey" name="dictkey"> 
				                                </div>
				                            </div>
				                             ...
				                             <div class="col-sm-9">
				                                ...
				                                <div class="col-sm-8">
				                                    <input type="text" class="form-control" id="dictgroup" name="dictgroup"> 
				                                </div>
				                            </div>
				                             <div class="col-sm-9">
    ...
    $(function(){
	    ...
	    $("#addsjzd_form").on("submit",function(){
	    	...
	    	$.ajax({
				url : '${path}/dictController/addElement',
				method: 'post',
				async: false,
				data:$('#addsjzd_form').serialize(),
				dataType : 'json',
