            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class=" bfr">
                            <a class="btn btn-info" onclick="opadd()" >新增角色</a>
 ...
 <script>
    var table;
		...
		//		"bStateSave":true,
				...
				"dom" : 'Blfrtip',
				"ajax" : {
					"url" : "${path}/roleinfoController/datagrid",
					"type" :"post",
					"data" : function(d) {
				...
				"columnDefs" : [
						{
							...
							"render" : function(data, type, row) {
								var buttons = '';
									buttons +="<a href='javascript:void(0);' class='btn btn-primary  btn-xs' onClick=\"roleinfo_ed('" + row.id + "')\" >编辑</a>";
				                    buttons +=" <a href='javascript:void(0);' class='btn btn-primary  btn-xs ' onClick=\"roleinfo_del('" + row.id + "')\" >删除</a>";
								return buttons;
							},
							"targets" :3,
						}],
		...
		function roleinfo_del(id) {
            layer.confirm('确认删除？', {
                              btn: ['确认','取消'] //按钮
                              	 ...
                              	 $.ajax({
                       				type: "post",
                       				url : '${path}/roleinfoController/deleteElement',
                       				data:{
                       					id:id
                       				},
                       				dataType:'json',
		...
		function roleinfo_ed(id) {
            layer.open({
                ...
                ,content: ['${path}/roleinfoController/toEditPage?id='+id]
            	  ,end: function(){
            			//layer.msg("修改成功");
  		    		//table.fnDraw();
  		    		table._fnAjaxUpdate(table.oSettings);
